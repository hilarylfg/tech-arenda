...
export default async function HomePage() {
	...
	return (
		<div className='animate-fade-in'>
			{/* Герой */}
			<section className='relative min-h-[80vh] flex items-center bg-linear-to-br from-stone-900 via-stone-800 to-amber-900 overflow-hidden'>
					...
					{featuredEquipment.length > 0 ? (
						<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
							{featuredEquipment.map(eq => (
								...
								>
									<div className='h-44 bg-linear-to-br from-stone-200 to-stone-300 relative overflow-hidden flex items-center justify-center'>
										{eq.images[0] ? (
											<img
												src={eq.images[0]}
												alt={eq.name}
